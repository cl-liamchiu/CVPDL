...
def build(image_set, args):
    ...
    PATHS = {
        ...
        "train_reg": (root / "train", root / "annotations" / 'train.json'),
        "val": (root / "valid", root / "annotations" / 'val.json'),
        "eval_debug": (root / "valid", root / "annotations" / 'val.json'),
        "test": (root / "valid", root / "annotations" / 'val.json'),
    }
